use super::images_helpers::{ImageType, depth_color, depth_range};
use crate::{
    processing::images::ImageType::{DepthImage, DifferenceImage},
    structs::depth_matrix::DepthMatrix,
};
...
pub fn makepng_with_matrix_and_interpolation(
    ...
    log_debug(&format!(
        "Extremos de la matriz calculados: {min_val}, {max_val}."
    ));
